...
public class StoreHelper {
    ...
    public static void goToMarket(Context context, String packageName) {
        ...
        if (isAvilible(context, "com.android.vending")) {
            // google play
            com.appsbay.minguoliteratural.Tools.StoreHelper.goToGoogleMarket(context, packageName);
        } else if (isAvilible(context, "com.sec.android.app.samsungapps")) {
            // samsung app store
            com.appsbay.minguoliteratural.Tools.StoreHelper.goToSamsungappsMarket(context, packageName);
        } else if (isAvilible(context, "com.amazon.venezia")) {
            // amazon app
            com.appsbay.minguoliteratural.Tools.StoreHelper.goToAmazonMarket(context, packageName);
        } else if (isAvilible(context, "com.xiaomi.market")) {
            // amazon app
            com.appsbay.minguoliteratural.Tools.StoreHelper.goToXiaoMiMarket(context, packageName);
        } else if (isAvilible(context, "com.oppo.market")) {
            // amazon app
            com.appsbay.minguoliteratural.Tools.StoreHelper.goToOPPOMarket(context, packageName);
        } else {
            com.appsbay.minguoliteratural.Tools.StoreHelper.goToGoogleMarket(context, packageName);
        }

...
import com.appsbay.minguoliteratural.Tools.Constants;
import com.appsbay.minguoliteratural.Tools.MyColor;
import com.appsbay.minguoliteratural.Tools.MyImage;
import com.appsbay.minguoliteratural.View.BooksLibraryListRecyclerViewAdapter;
import com.appsbay.minguoliteratural.Controller.Menu.MenuActivity;
...
public class LibraryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (BookLibrary.shared.books(mContext).size() == 0) {
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            textView.setTextColor(MyColor.getDetailTextColor(mContext));
